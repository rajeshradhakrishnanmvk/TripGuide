let gl_pattern,gl_solutions,gl_meanings ; // Declare a global variable
...
function boardSetup() {
    // const prompt = fs.readFileSync('/d:/TripGuide/brain/gold.txt', 'utf-8');
    // fetchConnectionsFromGemma(prompt);
...
function fetchConnectionsFromGemma(examples_prompt) {
    showGriLoading(true);
    fetch('https://generativelanguage.googleapis.com/v1/models/gemini-pro:generateContent?key=', {
        method: 'POST',
        headers: {
